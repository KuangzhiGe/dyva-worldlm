...
FINETUNE_RUN_ID="${MODEL_ID}_ft_proj_noalign_xt"
MULTI_RUN_ID="${MODEL_ID}_ft_proj_multi_image_fullmulti"
...
LLM_BAKCBONE_ID="llama2-7b-pure" #"llama2-7b-pure" "qwen25-7b-chat"
