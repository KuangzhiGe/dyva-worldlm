...
from typing import Callable, Dict, Tuple, List # type: ignore
...
class DinoSigLIPViTBackbone(VisionBackbone):
    def __init__(self, vision_backbone_id: str, image_resize_strategy: str, default_image_size: int = 224) -> None:
        ...
        self.dino_featurizer = self._create_model_with_retry(self.dino_timm_path_or_url)
        self.dino_featurizer.eval()

        self.siglip_featurizer = self._create_model_with_retry(self.siglip_timm_path_or_url)
    ...
    def _create_model_with_retry(self, url) -> VisionTransformer:
