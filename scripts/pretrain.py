...
class PretrainConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if self.stage == "align" or self.stage == "align-svd" or self.stage == "align-vae" or self.stage == "align-dual":
        ...
        elif self.stage.endswith("finetune") or self.stage.endswith("finetune-svd") or self.stage.endswith("finetune-vae") or self.stage.endswith("finetune-dual"):
...
def pretrain(cfg: PretrainConfig) -> None:
    ...
    vision_backbone, image_transform = get_vision_backbone_and_transform(
        cfg.model.vision_backbone_id, image_resize_strategy=cfg.model.image_resize_strategy, num_frames=cfg.num_frames
    )
    ...
    vlm.align_svd_with_llm = cfg.align_svd_with_llm
    vlm.align_weight = cfg.align_weight
    ...
    if "anyres" in vlm.vision_backbone.image_resize_strategy:
        is_anyres = True
    else:
        is_anyres = False
